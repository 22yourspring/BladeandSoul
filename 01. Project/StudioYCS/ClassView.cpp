...
int CClassView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndClassView.SetBkColor(RGB(35, 35, 35));
	m_wndClassView.SetLineColor(RGB(125, 125, 125));
...
{
	HTREEITEM hRoot = m_wndClassView.InsertItem(_T("Scene"), 1, 1);
...
void CClassView::init()
{
	m_wndClassView.init();
}

void CClassView::update()
{
	m_wndClassView.update();
}

void CClassView::Renew()
{
	m_wndClassView.Renew();
}
...
void CClassView::OnContextMenu(CWnd* pWnd, CPoint point)
{
	...
	pSumMenu->TrackPopupMenu(TPM_LEFTALIGN | TPM_RIGHTBUTTON, point.x, point.y, this);//	popup활성화 기존 Fakemenu 삭제
...
//	m_wndToolBar.SetWindowPos(nullptr, rectClient.left, rectClient.top, rectClient.Width(), cyTlb, SWP_NOACTIVATE | SWP_NOZORDER);
	m_wndClassView.SetWindowPos(nullptr, rectClient.left + 1, rectClient.top + 0 + 1, rectClient.Width() - 2, rectClient.Height() - 0 - 2, SWP_NOACTIVATE | SWP_NOZORDER);

	m_wndClassView.ShowScrollBar(SB_HORZ, FALSE);
}
