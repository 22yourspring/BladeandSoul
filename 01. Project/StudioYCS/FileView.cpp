...
#ifdef _DEBUG
#undef THIS_FILE
static char FileView_THIS_FILE[]=__FILE__;
...
int CFileView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	// 뷰를 만듭니다.
	const DWORD dwViewStyle = WS_CHILD | WS_VISIBLE | /*TVS_HASLINES |*/ /*TVS_LINESATROOT | TVS_HASBUTTONS | */TVS_DISABLEDRAGDROP;
	...
	m_wndFileView.SetBkColor(RGB(35, 35, 35));
	m_wndFileView.SetLineColor(RGB(125, 125, 125));
...
void CFileView::FillFileView()
{
	...
	HTREEITEM hRoot = m_wndFileView.InsertItem(_T("Scene Resource"), 0, 0);
...
//	m_wndToolBar.SetWindowPos(nullptr, rectClient.left, rectClient.top, rectClient.Width(), cyTlb, SWP_NOACTIVATE | SWP_NOZORDER);
	m_wndFileView.SetWindowPos(nullptr, rectClient.left + 1, rectClient.top + 0 + 1, rectClient.Width() - 2, rectClient.Height() - 0 - 2, SWP_NOACTIVATE | SWP_NOZORDER);

	m_wndFileView.ShowScrollBar(SB_HORZ, FALSE);
}
...
{
	m_wndFileView.update();
}

void CFileView::Renew()
{
	m_wndFileView.Renew();
}
